...
public class Controller implements Initializable{
    ...
    private CalculationMethod rangeKutta;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        rangeKutta = new RangeKutta(vars);
    ...
    private void showData() {
        ...
        if(rangeKuttaCB.isSelected()) {
            solution_chart.getData().add(rangeKutta.getCalculation());
            error_chart.getData().add(rangeKutta.getError(exact));
            max_error_chart.getData().add(rangeKutta.getMaxError(exact));
        }
    }
